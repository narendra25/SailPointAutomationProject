...
public class ApplicationReusableMethods extends TestBase {
	...
	public void CreateRuleOfSailPointApplication() throws Exception {
		...
		FileInputStream file = new FileInputStream(
				filePath + "/src/test/resources/DataFiles/CreationRulesSailPoint.xlsx");
		...
		for (int rowNum = 1; rowNum <= sheet.getLastRowNum(); rowNum++) {
			...
			webdriver.VerifyElementIsPresentorNot(ApplicationsPage.btnApplicationDefination, "Application",
